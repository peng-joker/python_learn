...
Label(win,text="→",padx=2,pady=2,foreground="#B22222").grid(row=1,column=2)
Label(win,text="→",padx=2,pady=2,foreground="#B22222").grid(row=1,column=4)
Label(win,text="↓",padx=2,pady=2,foreground="#B22222").grid(row=2,column=5)
Label(win,text="↓",padx=2,pady=2,foreground="#B22222").grid(row=4,column=5)
Label(win,text="←",padx=2,pady=2,foreground="#B22222").grid(row=5,column=4)
Label(win,text="←",padx=2,pady=2,foreground="#B22222").grid(row=5,column=2)
Label(win,text="↑",padx=2,pady=2,foreground="#B22222").grid(row=4,column=1)
Label(win,text="↑",padx=2,pady=2,foreground="#B22222").grid(row=2,column=1)
# 设置斗兽棋游戏的棋子的位置
